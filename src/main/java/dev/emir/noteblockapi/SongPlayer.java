    ...
    public void addPlayer(Player p) {
        synchronized (this) {
            if (!playerList.contains(p.getName())) {
                ...
                ArrayList<SongPlayer> songs = Main.getInstance().getNoteblock().playingSongs.get(p.getName());
                if (songs == null) {
                    songs = new ArrayList<SongPlayer>();
                }
                songs.add(this);
                Main.getInstance().getNoteblock().playingSongs.put(p.getName(), songs);
            }
        }
    }
    ...
    public void removePlayer(Player p) {
        synchronized (this) {
            ...
            ArrayList<SongPlayer> songs = new ArrayList<SongPlayer>(
                    Main.getInstance().getNoteblock().playingSongs.get(p.getName()));
            songs.remove(this);
            Main.getInstance().getNoteblock().playingSongs.put(p.getName(), songs);
